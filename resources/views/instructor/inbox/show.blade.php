...
<div class="page-content max-w-2xl">
    ...
    <div class="page-header">
        <div class="flex items-center gap-3">
            <a href="{{ route('instructor.inbox.index') }}" class="text-gray-400 hover:text-navy">
    ...
    <div class="mt-6 card">
        ...
        <form method="POST" action="{{ route('instructor.inbox.reply', $conversation) }}" class="space-y-3">
            @csrf
