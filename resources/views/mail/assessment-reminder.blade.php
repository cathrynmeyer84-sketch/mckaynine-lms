...
<div class="wrapper">
  <div class="card">
    ...
    <h1>See you tomorrow, {{ $assessmentRequest->handler?->first_name }}!</h1>
    <p>This is a friendly reminder that <strong>{{ $assessmentRequest->dog?->name }}</strong>'s assessment is tomorrow. We can't wait to meet you both!</p>
    ...
    @if($instructions)
    <p style="font-weight:600; color:#1a2e44; margin-bottom:4px;">A reminder of what to bring:</p>
