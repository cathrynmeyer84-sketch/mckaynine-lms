...
@section('title', 'Book Your Private Lesson')

@section('content')
<div class="page-content max-w-xl mx-auto py-10 px-4">

    <div class="mb-8">
        <h1 class="text-2xl font-bold text-navy">Book Your Private Lesson</h1>
        <p class="text-gray-500 mt-1 text-sm">Just a couple of quick questions, then you'll create your account and book your first session.</p>
    </div>
    ...
    <form method="POST" action="{{ route('enrol.private-lessons.store', $assessmentRequest) }}">
        @csrf

        {{-- Dog summary --}}
        <div class="card mb-6">
            <h2 class="font-semibold text-navy mb-3">Your Dog</h2>
        ...
        <div class="card mb-6">
            ...
            <div class="space-y-5">
                <div>
                    <label class="form-label">May we add you to our WhatsApp group? <span class="text-red-400">*</span></label>
        ...
        <button type="submit" class="btn btn-primary w-full">Continue to Create Account →</button>
        <p class="text-xs text-gray-400 text-center mt-3">You'll create your McKaynine account on the next step, then choose your lesson time.</p>
    </form>
</div>
@endsection
